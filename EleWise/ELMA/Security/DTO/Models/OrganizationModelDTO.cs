...
// Type: EleWise.ELMA.Security.DTO.Models.OrganizationModelDTO
...
{
  /// <summary>DTO для модели оргструктуры</summary>
  [Serializable]
  public class OrganizationModelDTO : EntityDTO<int>
  {
    internal static OrganizationModelDTO fWkC4uihyGr30hXYjHE;

    /// <summary>Диаграмма</summary>
    public OrganizationDiagram Diagram
    {
      get => this.\u003CDiagram\u003Ek__BackingField;
      set
      {
        int num = 1;
        while (true)
        {
          switch (num)
          {
            case 0:
              goto label_2;
            case 1:
              this.\u003CDiagram\u003Ek__BackingField = value;
...
label_4:;
    ...
    public OrganizationSubDiagram SubDiagrams
    {
      get => this.\u003CSubDiagrams\u003Ek__BackingField;
      set
      {
        int num = 1;
        while (true)
        {
          switch (num)
          {
            case 0:
              goto label_2;
            case 1:
              this.\u003CSubDiagrams\u003Ek__BackingField = value;
...
label_4:;
    ...
    public UserDTO ChangeAuthor
    {
      get => this.\u003CChangeAuthor\u003Ek__BackingField;
      set
      {
        int num = 1;
        while (true)
        {
          switch (num)
          {
            case 0:
              goto label_2;
            case 1:
              this.\u003CChangeAuthor\u003Ek__BackingField = value;
...
label_4:;
    ...
    internal static bool oJc5jqiBuPwhrZQMLbv() => OrganizationModelDTO.fWkC4uihyGr30hXYjHE == null;

    internal static OrganizationModelDTO g1R44aip1CTy7Qpst7P() => OrganizationModelDTO.fWkC4uihyGr30hXYjHE;
  }
}
