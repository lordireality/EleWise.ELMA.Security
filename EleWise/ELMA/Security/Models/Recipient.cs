...
// Type: EleWise.ELMA.Security.Models.Recipient
...
namespace EleWise.ELMA.Security.Models
{
  ...
  {
    internal static Recipient Sn59xj8Iqx9NG8oVrVW;

    /// <summary>Уникальный идентификатор типа получателя</summary>
    public Guid TypeUid
    {
...
label_4:;
    ...
    {
      get => this.\u003CRecipientId\u003Ek__BackingField;
      set
      {
        int num = 1;
        while (true)
        {
          switch (num)
          {
            case 0:
              goto label_2;
            case 1:
              this.\u003CRecipientId\u003Ek__BackingField = value;
...
label_4:;
    ...
    /// <summary>Идентификатор свойства с исполнителем</summary>
...
label_4:;
    ...
    /// <summary>Название свойства с исполнителем</summary>
...
label_4:;
    ...
    internal static bool vfxxWY8etY3iBiZQ8lT() => Recipient.Sn59xj8Iqx9NG8oVrVW == null;

    internal static Recipient rtTpeW8n54Y6nfFKS9O() => Recipient.Sn59xj8Iqx9NG8oVrVW;

    internal static void dGkOei8LuXxOHInWNLI() => TKW1L3mlUyvXmg29jA.nXAwQxeC0Y9();
  }
}
